...
const Testimonials = () => {
  ...
  return (
    <section id="testimonials" className="mx-auto w-full max-w-7xl px-5 py-16 md:px-10 md:py-24 lg:py-32" aria-labelledby="testimonials-title">
      ...
      <div className="grid gap-5 sm:grid-cols-2 md:grid-cols-3">
        {testimonials.map((testimonial) => (
          <div key={testimonial} className="flex flex-col items-center p-8 text-center bg-gray-50 rounded-lg">
            <div className="mb-4 rounded-full bg-blue-100 p-2">
