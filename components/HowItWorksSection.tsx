...
import { Play, Target, Trophy, Star } from 'lucide-react';
      ...
      <div className="mx-auto max-w-7xl px-5 md:px-10">
        ...
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
          <div className="flex flex-col items-center p-8 text-center">
            <Play className="mb-4 h-12 w-12 text-blue-500" />
          ...
          <div className="flex flex-col items-center p-8 text-center">
            <Trophy className="mb-4 h-12 w-12 text-blue-500" />
          ...
          <div className="flex flex-col items-center p-8 text-center">
            <Star className="mb-4 h-12 w-12 text-blue-500" />
