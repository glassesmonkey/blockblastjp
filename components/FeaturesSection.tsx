...
import { Gamepad, Star, Trophy, Zap, Users } from 'lucide-react';
        ...
        <div className="flex flex-col items-center order-2 lg:order-1 lg:w-1/2">
          ...
          <ul className="grid max-w-2xl grid-cols-2 sm:gap-5 lg:max-w-none">
            <li className="flex flex-col p-5">
              ...
              <p className="mb-4 font-semibold">{t('features.classicMode.title')}</p>
              <p className="text-sm text-gray-500">
                {t('features.classicMode.description')}
              </p>
            </li>
            <li className="flex flex-col p-5">
              <Star className="mb-4 inline-block rounded-full" size={40} />
              <p className="mb-4 font-semibold">{t('features.adventureMode.title')}</p>
              <p className="text-sm text-gray-500">
                {t('features.adventureMode.description')}
              </p>
            </li>
            <li className="flex flex-col p-5">
              <Trophy className="mb-4 inline-block rounded-full" size={40} />
              <p className="mb-4 font-semibold">{t('features.challenges.title')}</p>
              <p className="text-sm text-gray-500">
            ...
            <li className="flex flex-col p-5">
              ...
              <p className="mb-4 font-semibold">{t('features.offlinePlay.title')}</p>
              <p className="text-sm text-gray-500">
                {t('features.offlinePlay.description')}
              </p>
            </li>
            <li className="flex flex-col p-5">
